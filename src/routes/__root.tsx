  ...
  head: () => ({
    meta: [
      ...
      { title: "Dr. Amanuel Hospital — Bishoftu, Ethiopia (Demo)" },
      {
        name: "description",
        content:
          "Portfolio demo website for Dr. Amanuel Hospital in Bishoftu, Ethiopia. Quality healthcare, 24/7 emergency, experienced doctors and modern equipment.",
      },
      { name: "author", content: "Portfolio Demo" },
      { property: "og:title", content: "Dr. Amanuel Hospital — Bishoftu, Ethiopia (Demo)" },
      {
        property: "og:description",
        content:
          "Portfolio demo healthcare website — compassionate care, modern technology, patient-centered services.",
      },
