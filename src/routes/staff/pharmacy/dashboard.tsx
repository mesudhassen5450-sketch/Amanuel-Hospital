            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl">
              <Link to="/staff/pharmacy/prescriptions">
                <Card className="border border-slate-200 dark:border-slate-800 bg-amber-50 dark:bg-amber-950/20 hover:bg-amber-100 dark:hover:bg-amber-950/30 transition-colors cursor-pointer rounded-2xl">
                  <CardContent className="p-5 flex items-center gap-4">
                    <div className="bg-amber-500/15 p-3 rounded-xl text-amber-600 dark:text-amber-400"><Pill className="h-6 w-6" /></div>
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white">Prescriptions</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">Pending & dispense</p>
                    </div>
                  </CardContent>
                </Card>
              </Link>
              <Link to="/staff/pharmacy/dispensed">
                <Card className="border border-slate-200 dark:border-slate-800 bg-emerald-50 dark:bg-emerald-950/20 hover:bg-emerald-100 dark:hover:bg-emerald-950/30 transition-colors cursor-pointer rounded-2xl">
                  <CardContent className="p-5 flex items-center gap-4">
                    <div className="bg-emerald-500/15 p-3 rounded-xl text-emerald-600 dark:text-emerald-400"><CheckCircle2 className="h-6 w-6" /></div>
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white">Dispensed</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">History</p>
                    </div>
                  </CardContent>
                </Card>
              </Link>
              <Link to="/staff/pharmacy/inventory">
                <Card className="border border-slate-200 dark:border-slate-800 bg-blue-50 dark:bg-blue-950/20 hover:bg-blue-100 dark:hover:bg-blue-950/30 transition-colors cursor-pointer rounded-2xl">
                  <CardContent className="p-5 flex items-center gap-4">
                    <div className="bg-blue-500/15 p-3 rounded-xl text-blue-600 dark:text-blue-400"><Package className="h-6 w-6" /></div>
                    <div>
                      <p className="font-semibold text-slate-900 dark:text-white">Inventory</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400">Medicine stock</p>
                    </div>
                  </CardContent>
                </Card>
              </Link>
